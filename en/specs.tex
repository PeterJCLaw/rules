...
\item The arena features nine \textit{squares}.
  ...
  \begin{figure}
    ...
    \caption{The positions of the nine squares in the arena.
...
\item Each token is associated with its own libkoki marker number.
      Each token is labelled with six identical $280mm$ libkoki markers -- one on each face.
\end {enumerate}
...
\begin{figure}
  ...
  \caption{Dimensions of the pedestal.
...
\begin{enumerate}
\item Pedestals are cuboid structures with the dimensions shown in figure~\ref{fig:bucket-3d}.
