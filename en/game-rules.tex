...
\item The game, called \textbf{Sunny Side Up}, will be played in the arena defined in section~\ref{sub:arena}.
      The objective of this game is to have as many tokens with your team colour facing up\footnote{\label{define-up}Up means the face is $\leq 10\degree$ from horizontal} by the end of the match.
...
\item At the end of a match, each team's \textbf{game points} will be calculated.
      ...
      % TODO: make this also reference the definition of 'facing up'
