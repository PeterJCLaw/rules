...
\begin{enumerate}
  \item \textbf{1 point} will be awarded for initial movement outside the starting corner, defined as when the back of the robot passes over the marked corner boundary.
  ...
  \item \textbf{1 point} will be awarded for placing a token in an upright orientation anywhere in the arena.
  ...
  \item \textbf{Bonus  points} will be awarded for occupying two or more adjacent slots on the same side of the zone wall.
        ...
        For example, placing three tokens in a row on one side of the wall will yield a bonus of 3 points.
\end{enumerate}
