...
\begin{itemize}
  ...
  \item If there are any buckets within the team's zone, the team's \textbf{total score} will be multiplied by the number of buckets within their zone.  Buckets that span two adjacent zones will not be counted.
