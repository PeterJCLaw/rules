...
\item The arena (see \emph{Specification} section) will contain 9 tokens (8 around the track, and 1 on the ramp).
 They will be arranged randomly, with 2 on each side as shown in figure~\ref{fig:arena-dim}.
