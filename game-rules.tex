...
\item There are 25 scoring zones in the arena, arranged in a 5x5 grid. The outer 16 are known as the ``outer ring'', the inner 8 are known as the ``inner ring'', and the most central zone is known as the ``pit''. The inner ring is elevated from the floor by 50 mm $\pm$ 5 mm, so to access the pit robots will need to climb onto it.
