...
\item If, at the end of the game, a robot is ``in'' a zone\footnote{A robot is ``in'' a zone iff the projection of the centroid of its flag mounting cylinder (see \ref{sub:robot-flag}) onto the floor of the arena is within the zone.}, the value of that zone and the four zones immediately adjacent in the cardinal directions are tripled. This effect compounds with multiple robots, meaning that it is possible for the value of a zone to be increased 81-fold in one theoretical case.
