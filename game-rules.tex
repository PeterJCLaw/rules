...
\begin{enumerate}
\item The game, called \textbf{Two Colours}, will be played in the arena defined in section~\ref{sub:arena}.  The objective of this game is to capture the most coloured tokens, but without mixing the two colours.
...
\item Points are awarded at the end of the game or tokens if robots can carry them into their scoring zones.
