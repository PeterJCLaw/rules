...
\begin{enumerate}
  \item A ``robot flag'' is a removable identifier that will be attached to a robot throughout a match.
        It features identifying areas to allow spectators to easily associate a robot with its starting position.
...
\item There will be 40 tokens in the arena: 10 associated with each starting position.  These will be arranged as shown in figure~\ref{fig:arena-dim} at the start of a match.
