...
\item No guarantee is offered of the colour of the area inside the internal wall (the section greyed out in figure~\ref{fig:arena-dim}). We can guarantee, however, that anything visible within the arena above 200mm and below 600mm will be either white or black (as those colours are not visible to the vision system).
\end{enumerate}
...
\label{tokens}
\begin {enumerate} 
\item Tokens are baked-bean cans of height $XXmm$ and diameter $XXmm$.
